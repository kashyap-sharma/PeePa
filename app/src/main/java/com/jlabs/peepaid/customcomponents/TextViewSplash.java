...
public class TextViewSplash extends TextView {
    ...
    public TextViewSplash(Context context) {
        ...
        Typeface tf = FontCache.get("fonts/DyaneRegular.ttf", context);
        if(tf != null) {
            this.setTypeface(tf);
    ...
    public TextViewSplash(Context context, AttributeSet attrs) {
        ...
        {
            tf= FontCache.get("fonts/DyaneRegular.ttf", context);
        }
        ...
        {
            tf= FontCache.get("fonts/DyaneRegular.ttf.ttf", context);
    ...
    public TextViewSplash(Context context, AttributeSet attrs, int defStyle) {
